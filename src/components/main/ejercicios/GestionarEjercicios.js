                    ...
                    <Col xs={12}>
                        <div className="contenedorPrincipal">
                            <div className="informacionTema">
                                ...
                                <p>Es necesario seleccionar un ejercicio para editar o para cambiar su estado de activo a inactivo.</p>
                            </div>
                        </div>
                    </Col>
                    <Col xs={12}>
                        <div className="contenedorTabla">
                            ...
                            <table className="tablaTemas">
                              ...
                              ${ejercicioSeleccionado && ejercicioSeleccionado.idEjercicio === ejercicio.idEjercicio
                                                        ? "selectedRow"
                                                        : ""}
                            `}
                                            >
